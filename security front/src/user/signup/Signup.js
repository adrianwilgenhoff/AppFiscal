...
class Signup extends Component {
    ...
    handleInputChange(event, validationFun) {
        ...
        this.setState({
            [inputName]: { value: inputValue, ...validationFun(inputValue) },
        });
    }
        ...
        signup(signupRequest)
            .then(response => {
                notification.success({
                    message: 'Fiscal App',
                    description: "Thank you! You're successfully registered. Please check your email to continue!",
                });
    ...
    isFormInvalid() {
        return !(this.state.name.validateStatus === 'success' &&
            ...
            this.state.repeatpassword.validateStatus === 'success'
        );
    }
                ...
                <div className="signup-content">
                    <Form onSubmit={this.handleSubmit} className="signup-form">
                        ...
                        <Form.Item
                            ...
                            help={this.state.repeatpassword.errorMsg}>
                            <Input.Password
                                size="large"
                                name="repeatpassword"
                                type="password"
